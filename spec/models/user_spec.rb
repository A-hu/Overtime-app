...
RSpec.describe User, type: :model do
  ...
  describe "validations" do
    it "cannot be validated without first_name" do
      @user.first_name = nil
      expect(@user).to_not be_valid
    end

    it "cannot be validated without last_name" do
      @user.last_name = nil
      expect(@user).to_not be_valid
    end

    it "cannot be validated without phone" do
      @user.phone = nil
      expect(@user).to_not be_valid
    end
  ...
  describe "custom name methods" do
    it 'has a full name method that combines first and last name' do
      expect(@user.full_name).to eq("HELLO, HIHI")
    end
  end

  describe 'relationship between admins and employees' do
    it 'allows for admins to be assoicated with multiple employees' do
